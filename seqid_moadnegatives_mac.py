...
bricks = ['1ofv','1qys','5bvl','2fd7','4hjk','1igd','4tql','1amm','2alp']
...
moad_negatives_simulated = ['1yda','2hiz','6cd4','1ove','2xjg','1oit','1v2n','2zjw','1os5','1e5o','1aax','3b0w','1kei']
...
proteins_all = np.unique(new_bricks_cryptosite+prot_names+cryptosite_added_prots+moad_negatives_simulated)
...
for i in new_bricks_cryptosite+cryptosite_added_prots+moad_negatives_simulated:
    ...
    for y, prot2 in enumerate(proteins_all[x+1:]):
        ...
        if seqid > id_cutoff: #and seqid > (1-minlen/maxlen)*len_scale:
            ...
            if prot2 in test_val_set:
                ...
                p2_class=" (brick)"
            elif prot2 in cryptosite_added_prots:
                p2_class=" (cryptosite new)"
            elif prot2 in moad_negatives_simulated:
                p2_class=" (moad negative)"
            else:
                p2_class=" (5fcv/train)"
